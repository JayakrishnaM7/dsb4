...
public interface V1Api {
    ...
    @ApiOperation(value = "", nickname = "v1Bian3CorePayment1000GetAccountbalanceGet", notes = "retrive payment details by paymentorderid", response = Account.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = Account.class) })
    @RequestMapping(value = "/v1/bian-3/core/payment/10.0.0/getAccountbalance",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Account> v1Bian3CorePayment1000GetAccountbalanceGet(); 


    @ApiOperation(value = "", nickname = "v1Bian3CorePayment1000InitpaymentPost", notes = "External Fund transfer Initiation", tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "", nickname = "v1Bian3CorePayment1000UpdatepaymentPut", notes = "updatepayment payment details", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success") })
    ...
    ResponseEntity<Void> v1Bian3CorePayment1000UpdatepaymentPut(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Updatepayment updatepayment); 
